        ...
        <div className="relative z-1 mx-auto max-w-c-1390 rounded-lg bg-gradient-to-t from-[#F8F9FF] to-[#DEE7FF] py-22.5 dark:bg-blacksection dark:bg-gradient-to-t dark:from-transparent dark:to-transparent dark:stroke-strokedark xl:py-27.5">
          ...
          >
            ...
            <p className="mx-auto lg:w-11/12">
              Our innovative logistics platform powers seamless shipping
              experiences for global enterprises. With real-time tracking,
              advanced security, and unmatched reliability, we drive efficiency
          ...
          <div className="flex flex-wrap justify-center gap-8 lg:gap-42.5">
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Packages Delivered</p>
            </motion.div>
            <motion.div
              variants={{
                hidden: {
            ...
            >
              ...
              <p className="text-lg lg:text-para2">Countries Served</p>
            </motion.div>
          </div>
        </div>
      </section>
